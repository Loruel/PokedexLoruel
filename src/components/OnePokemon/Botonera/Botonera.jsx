...
export default function Botonera({ Numero }) {
  return (
    <div className='flex items-center w-full h-10 mb-2 p-2 bg-black rounded-lg dark:bg-white'>

      <AnteriorPoke
        Numero={Numero} />

      <figure className='flex justify-center items-center w-1/3'>
